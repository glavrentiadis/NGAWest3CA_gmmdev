...
#BA18 coefficients
fn_ba18_coeffs = '../../../Raw_files/BA18coefs_mod.csv'
#updated gmm coefficients
fn_upd_coeffs = '../../../Raw_files/coeff_20241021_mod2.csv'

#output directory
dir_out = '../../../Data/gmm_ergodic/verification/dataset/'
dir_out += 'updated_gs/' if flag_upd_gs else 'original_gs/'
...
#read coefficients
if flag_upd_gs:
    df_coeffs  = pd.read_csv(fn_upd_coeffs)
else:
    df_coeffs = pd.read_csv(fn_ba18_coeffs)
    #frequencies to keep
